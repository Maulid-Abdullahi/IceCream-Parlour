                            ...
                            <div class="single_abouts_text wow slideInRight" data-wow-duration="1s">
                                <form class="form-signin" method="post" action="register">       
                                    ...
                                    <input type="text" class="form-control" name="username" placeholder="Username" required="required" autofocus="" />
                                      <input type="tel" class="form-control" name="phone" placeholder="Phone Number" required="required" autofocus="" />
                                    <input type="password" class="form-control" name="password" placeholder="Password" required=""/>      
                                    <div class="form-group">

                                    </div>              
                                    <button style="color: black"class="btn btn-lg btn-primary btn-block" type="submit" name="" >Sign Up</button> 
                                    <h6><a href="Signup.jsp">Have an Account</a></h6>
