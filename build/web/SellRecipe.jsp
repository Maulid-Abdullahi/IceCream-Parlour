                            ...
                            <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                    ...
                                    <ul class="nav navbar-nav navbar-right">
                                        ...
                                        <li><a href="#ContactUs.jsp">Sell Recipe</a></li>
...
<center><form name="input" action="#" method="post">
  ...
  <b><p>Flavor</p></b><select name="flavor">
  ...
  <br/>
  <b>Upload Recipe Here: </b>
 <div class="form-group">
     
      <input type="file" name="recipe" id="email_content_ejs" class="form-control"/>
 </div>
  
  
 <b> <p>Payment Method</p></b><select name="paymentmethod">
  ...
  <input type="submit" value="Send" >
    ...
    $('#grid').click(function(event){event.preventDefault();$('#products .item').removeClass('list-group-item');$('#products .item').addClass('grid-group-item');});
            ...
            <script>
            function handleCheckSendToAll(checkbox) {
		// window.alert("check");
		if(checkbox.checked) {
			...
			$('#display_name').prop("required",true);
	...
	function beforeSubmit(){
		if ($('#is_send_to_all').prop('checked') && $('#is_send_to_unregistered').prop('checked')) {
		    confirm("Please check only one checkbox!");
            return false;
		}

        if ($('#is_send_to_all').prop('checked')) {
			return confirm("The uploaded email will be send to all users!");
		}

        if ($('#is_send_to_unregistered').prop('checked')) {
			return confirm("The uploaded email will be send to all unregistered customers!");
		}
		return true;
	}

	function formOutbound() {
        ...
        if ($('#is_send_to_all').prop('checked')) {
			decision = confirm("The uploaded email will be send to all users!");
			if(decision) {
				document.querySelector("form[name=test_form]").submit();
			}
			return decision;
		}

        if ($('#is_send_to_unregistered').prop('checked')) {
			decision = confirm("The uploaded email will be send to all unregistered customers!");
			if(decision) {
				document.querySelector("form[name=test_form]").submit();
			}
			return decision;
  ...
  function resetForm() {
    ...
    $('#is_send_to_all').prop('checked', false) ;
    $('#is_send_to_all').prop('value', true);
    $('#is_send_to_unregistered').prop('checked', false);
    $('#is_send_to_unregistered').prop('value', true);
    ...
    $('#email_content_ejs').prop("value", "");
    
    $('input[name="send_to_one_user"]').prop("value", "Send");
    $('input[name="send_to_one_user"]').prop("disabled", false);
    clearTimeout($('input[name="send_to_one_user"]'));
