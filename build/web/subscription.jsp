 ...
 <h1>Subscribe</h1>
  ...
  <div class="row">
    <div class="col-md-6">
      <h4>Our Packages</h4>
      <h5>$150 annually</h5>
      <p><b>With the annual subscription, you get access to unlimited number of recipes available on the site.
      <br />
      <br/>
      <h5>$15 monthly</h5>
      For the monthly subscription, you only get access to a limited number of recipes available on the site
          </b></p>
      <!-- Plan links use data attributes to call the correct plan. Each data-cb-plan-id is assigned to an ID in Chargebee. -->
      <a class="btn btn-success btn-block" href="SubscribeYearly.jsp" data-cb-type="checkout" data-cb-plan-id="county-wire---one-region---annual"> subscribe annually</a>
      <a class="btn btn-info btn-block" href="SubscribeMonthly.jsp" data-cb-type="checkout" data-cb-plan-id="county-wire---one-region---monthly"> subscribe monthly</a>
    </div>
