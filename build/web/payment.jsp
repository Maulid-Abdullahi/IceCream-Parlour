...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body>
        ...
        <form method="post" action="payment">
            <b> <p>Email</p><input type="email" placeholder="abcd@ghi.com" name="email">
                <p>Credit Card</p><input type="text" maxlength="16" placeholder="1234 1234 1234 1234" name="card">
