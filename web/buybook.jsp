...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <div id="products" class="row list-group">
        ...
        <div style="float: right"  class="item  col-xs-4 col-lg-4">
            <div class="thumbnail">
                <img class="group list-group-image" src="assets/images/pages/book2.jpg" alt="" />
                <div class="caption">
                    <h4 class="group inner list-group-item-heading">
                        Ice Cream Recipes</h4>
                    <p class="group inner list-group-item-text">
                       this is a good book to learn making ice cream  from
                                    scratch, i idvice you to learn it....<br />
                                    Buy Now @ $200</p>
                    <div class="row">
                        
                        <div class="col-xs-12 col-md-6">
                            <a class="btn btn-success" href="payment.jsp">Buy</a>
                        </div>
                    </div>
                </div>
            </div>
