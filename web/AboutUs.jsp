                        ...
                        <div class="main_slider text-center">
                            <div class="col-md-12">
                                <div class="main_slider_content wow zoomIn" data-wow-duration="1s">
                                    <h1>What Is ScoopIt?</h1>
                                    <p>SCOOPIT!is an ice cream shop that offers sales and recipes of various ice cream products to various clients across the country</p>
                    ...
                    <div class="abouts_content">
                        ...
                        <div class="col-md-6">
                            <div class="single_abouts_text wow slideInRight" data-wow-duration="1s">
                                <h4>What does</h4>
                                <h3> Scoop it offer?</h3>
                                <p>SCOOPIT! offers various ice cream products and recipe books to clients across the country. 
                                    We also offer online services for ice cream and recipes orders. We also have an 
                                    online loyalty program that allows a client(s) to register in our website 
                                    at a price. The client(s) will be able to receive products or recipes, if registered.</p>
                                ...
                                <div class="main_features_content text-left">
                                    <div class="col-md-6">
                                        <div class="single_features_text">
                                            ...
                                            <p>SCOOPIT! was established in 2012 in Nairobi, Kenya by a young couple Mr. and Mrs. A. 
                                                It started of as a small ice cream shop in Kilimani area in the suburbs of Nairobi 
                                                and later expanded to various locations across the country. 
                                                They both realized thier love for sweet things and moreso ice-cream and made a
                                                business out of it, gaining support from family,friends and ofcourse loyal customers</p></b>
