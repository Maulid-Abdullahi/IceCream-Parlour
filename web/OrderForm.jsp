...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
 ...
 <!--[if lt IE 8]>
        ...
        <section id="slider" class="slider1">
  ...
  <div id="inputs">
  <div>
<center><form name="input" action="OrderForm" method="post">
  <h1>Order</h1>
  ...
  <br/>
  <b> Address:</b><input type="text" name="address" placeholder="1234 Street City, ST Zip">
 <br/>
 <br/>
 <b><p>Flavor</p></b><select name="flavor">
  ...
  <br/>
  <b> Quantity:</b><input type="text" name="quantity" placeholder="10">
 <br/>
